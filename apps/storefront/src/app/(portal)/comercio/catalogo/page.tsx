...
export default function CatalogoComercioPage() {
      ...
      <nav className="bg-white border-b border-gray-100 px-6 py-4 sticky top-0 z-10">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm text-gray-500">Mayoristas</span>
          </div>
                    ...
                    <div className="flex flex-col gap-2 flex-shrink-0">
                      ...
                      {!solicitud && (
                        <button
                          ...
                          className="px-4 py-2 bg-gray-900 text-white rounded-xl text-sm font-medium hover:bg-gray-800 transition-colors disabled:opacity-60"
                        >
                          {solicitando === m.id ? "Solicitando..." : "Solicitar alta"}
                        </button>
                      )}
                      {solicitud?.estado === "rechazado" && (
                        <a href={`mailto:${m.email}`} className="px-4 py-2 border border-gray-200 text-gray-600 rounded-xl text-sm font-medium hover:bg-gray-50 transition-colors text-center">
                          Contactar
                        </a>
                      )}
                    </div>
